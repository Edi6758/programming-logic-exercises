...
def aluguel_de_carro():
    tipoDeCarro = input("Digite o seu tipo de carro (popular) OR (luxo)")
    diasAlugados = int(input("Informe os dias que o carro vai ser alugado"))
    kmPercorrido = int(input("Informe os KM percorrido"))
    aluguel = 0
